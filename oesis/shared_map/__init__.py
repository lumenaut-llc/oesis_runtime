"""Lane-aware shared-map package helpers."""
...
_LANE_TO_PACKAGE = {
    "v0.1": "oesis.shared_map.v0_1",
    "v0.2": "oesis.shared_map.v0_2",
    "v0.3": "oesis.shared_map.v0_3",
    "v0.4": "oesis.shared_map.v0_4",
    "v0.5": "oesis.shared_map.v0_5",
    "v1.0": "oesis.shared_map.v1_0",
}
